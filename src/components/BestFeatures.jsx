  ...
  return (
    <div className="flex flex-wrap justify-evenly items-center my-2">
      ...
      {featureContents.map((feature) => (
        <div key={feature.heading} className="flex justify-between items-center border-dashed border-2 border-gray-300 p-4 rounded-lg hover:border-yellow-400 max-w-96 my-3">

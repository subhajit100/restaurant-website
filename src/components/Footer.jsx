...
const Footer = () => {
  return (
    <>
      <div className="bg-[#181818] pt-24">
        <div className="mx-4 flex justify-center items-center relative pb-20">
          <img
            ...
            className="z-10"
          />
          <hr className="block w-[100%] border-solid border-gray-700 border-b-0 border-t absolute"></hr>
        </div>
        <div className="lg:flex mt-5 lg:justify-around lg:items-start pb-28 grid  md:grid-cols-2 gap-4 gap-y-8 grid-cols-1 justify-items-center justify-center">
          {/* each of below cards are div structures */}
          <div className="flex flex-col justify-center items-center lg:ml-10">
      ...
      <div className="bg-[#00a850] min-h-24 md:flex md:justify-between md:items-center px-4 grid grid-cols-1 gap-4 gap-y-8 justify-items-center justify-center py-2">
        <div className="text-white text-md">
          Copyright © 2022 <span className="text-yellow-500">pocofood</span>.
          All Rights Reserved.
        </div>
        <div>
          <img
            src="/images/footer_cards.png"
            alt="Footer cards"
            width={300}
            className="h-auto"
          />
